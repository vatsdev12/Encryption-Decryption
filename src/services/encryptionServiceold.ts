...
class EncryptionService {
    ...
    async encryptObject(modelName: string, data: any, kmsKeyName?: string, userKeyDetails?: UserKeyDetails): Promise<EncryptedObjectResult> {
        ...
        if (userKeyDetails) {
            ...
            if (userKeyDetails.locationId && userKeyDetails.keyRingId && userKeyDetails.keyId) {
